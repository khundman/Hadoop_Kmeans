...
public class med_EC extends Configured implements Tool 
{
    ...
    {
		JobConf conf = new JobConf(getConf(), med_EC.class); ///
		conf.setJobName("med_EC");
    ...
    {
		int res = ToolRunner.run(new Configuration(), new med_EC(), args);///
		System.exit(res);
    }
}
